        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div
                key={topic}
                className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.08)]"
              >
                <p className="text-sm font-semibold text-slate-900">{topic}</p>
                <p className="mt-2 text-sm text-slate-600">
                  Curated modules with clear outcomes and student-friendly
                  pacing.
                </p>
              </div>
            ))}
